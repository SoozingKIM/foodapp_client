      ...
      return (
        <View>
          ...
          <Text style={stylesForTutorial.text}>
            ...
            <Text
              style={[
                stylesForTutorial.text,
                { color: "#ef802f", fontWeight: "bold" },
              ]}
            >
              {" "}
              안심한끼
  ...
  function TutorialPage2() {
    if (isPressed == 1) {
      return (
        ...
        >
          <Image
            source={require('../image/2/안심식당_사진.png')}
