...
const KeywordStart = () =>{
    ...
    function KeywordText(){
        if(isPressed!=4){
            return(
                <View style={{height:490,width:'100%',position:'absolute', alignItems:'center',}}> 
                        <View style={stylesForKeyword.card}>
                            { KeywordPage() }
                        </View>
                        <Image  style={stylesForKeyword.logo}
                            resizeMode="contain"
        ...
        if(isPressed==2){
            return(
                <View>
                    ...
                    <Text style={stylesForKeyword.text}>한 눈에 알려줄 안심키워드를 뽑아왔어.</Text>
                </View>
            )
        }
        if(isPressed==3){
            return(
                <View>
                    ...
                    <Text style={stylesForKeyword.text}>
                        <Text style={{color:'#ef802f', fontWeight:'bold'}}>안심식당</Text> 추천을 위해 쓰일거야!
                    </Text>
                </View>
            )
        }
